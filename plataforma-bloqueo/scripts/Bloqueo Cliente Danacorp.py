"""
Bloqueo Cliente Danacorp.py
Envía un correo de bloqueo de cliente a Danacorp vía SMTP de Gmail.

Uso con datos:   python "Bloqueo Cliente Danacorp.py" '{"rut":"...", ...}'
"""
...
DESTINATARIOS = ["sdonoso@danacorp.cl"]
...
def bloquear_cliente(data: dict) -> dict:
    if not DESTINATARIOS:
        return {"status": "error", "message": "Destinatarios de Danacorp aún no configurados."}
