"""
Bloqueo Clientes Viva.py
Envía un correo de bloqueo de cliente a Viva vía SMTP de Gmail.

Uso con datos:   python "Bloqueo Clientes Viva.py" '{"rut":"...", ...}'
"""
