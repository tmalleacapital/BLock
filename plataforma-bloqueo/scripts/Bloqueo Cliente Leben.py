"""
Bloqueo Cliente Leben.py
Envía un correo de bloqueo de cliente a Leben vía SMTP de Gmail.

Uso con datos:   python "Bloqueo Cliente Leben.py" '{"rut":"...", ...}'
"""
...
DESTINATARIOS = ["lsilva@ileben.cl", "jfoppiano@ileben.cl"]
...
def bloquear_cliente(data: dict) -> dict:
    if not DESTINATARIOS:
        return {"status": "error", "message": "Destinatarios de Leben aún no configurados."}
