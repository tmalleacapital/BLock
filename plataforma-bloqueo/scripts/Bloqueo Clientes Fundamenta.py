"""
Bloqueo Clientes Fundamenta.py
Envía el correo de bloqueo de cliente a Fundamenta vía SMTP de Gmail.

Uso con datos:   python "Bloqueo Clientes Fundamenta.py" '{"rut":"...", ...}'
"""
