"""
Bloqeuo Clientes Fundamenta.py
Envía un correo de bloqueo de cliente a Fundamenta vía SMTP de Gmail.

Uso con datos:   python "Bloqeuo Clientes Fundamenta.py" '{"rut":"...", ...}'
"""
